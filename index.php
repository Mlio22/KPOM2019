      ...
      // apakah form telah disubmit
          ...
          if(mysqli_num_rows($hasil) == 0){
              ...
              if(mysqli_num_rows($hasil) == 0){
                  ...
                  $query = "SELECT * FROM `pemilih` WHERE username = '$username' AND password = '$password' AND (tokenOsim = 1 OR tokenMps = 1);";
                  $hasil = mysqli_query($koneksi,$query);

                  if(mysqli_num_rows($hasil) == 0){
                      $pesan = 'akun ini telah digunakan';
                      $username1 = $username;
                  }
              }
          }
...
<head>
    ...
    <style type="text/css">
      body{
        background-image:url('public/img/source/KPOM Log In.png');
      }
    </style>
</head>
...
<body>
        ...
        <form action="index.php" method="post" target="_self">
          <div class="row">
              <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                  <input class="form-control input-lg" type="text" name="username" placeholder="Username" maxlength="40" minlength="1" autofocus="" required value="<?php if(isset($username1)){echo $username1;} ?>">
              </div>
    ...
    <script src="public/assets for login/js/jquery.min.js"></script>
    <script src="public/assets for login/bootstrap/js/bootstrap.min.js"></script>
</body>
