    ...
    <div id="kontainer">
        ...
        <div id="konten">
            <div class="container">
                ...
                <h3 class="text-uppercase text-center">Calon Ketua dan Wakil Ketua OSIM 2018 / 2019</h3>
                <div id="TempatFoto">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-md-offset-3 col-sm-12 col-xs-12 FotoTulisan" id="FotoPertama" onclick="terpilih1(0)" onmouseover="jelaskan(0,'t1')" onmouseout="blurkan(this.id,'t1')">
                          <div class="places" id="one">
                            <p class="TulisanCalon" id="t1">dani</p>
                        </div>
                      </div>
                        <div class="col-md-3 col-md-offset-0 col-sm-12 col-xs-12 FotoTulisan" onclick="terpilih1(1)" onmouseover="jelaskan(1,'t2')" onmouseout="blurkan(this.id,'t2')">
                            <div class="places" id="two">
                            <p class="TulisanCalon" id="t2">yudha</p>
                          </div>
                        </div>
                        <div class="col-md-3 col-md-offset-0 col-sm-12 col-xs-12 FotoTulisan" onclick="terpilih1(2)" onmouseover="jelaskan(2,'t3')" onmouseout="blurkan(this.id,'t3')">
                          <div class="places" id="three">
                            <p class="TulisanCalon" id="t3">karom</p>
                          </div>
                        </div>
                    </div>
                </div>
